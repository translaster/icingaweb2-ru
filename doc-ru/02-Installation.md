...
Предпочтительным способом установки Icinga Web 2 является использование официальных репозиториев пакетов в зависимости от
используемой операционной системы и дистрибутива.

В случае, если вы обновляетесь с более старой версии Icinga Web 2
пожалуйста, обязательно тщательно ознакомьтесь с разделом [обновления](80-Upgrading.md#upgrading).

Исходные и автоматизированные настройки описаны в разделе [дополнительные разделы](20-Advanced-Topics.md#advanced-topics)
глава.

## Требования к установке <a id="installing-requirements"></a>

* [[Icinga2](https://icinga.com/products/icinga-2/) с IDO бэкендом базы данных (MySQL или PostgreSQL)
* Веб-сервер, например Apache или Nginx
* Версия PHP >= 5.6.0
* Необходимо установить следующие модули PHP: cURL, gettext, intl, mbstring, OpenSSL и xml
* Библиотека LDAP PHP при использовании Active Directory или LDAP для аутентификации
* PHP-библиотеки MySQL или PostgreSQL

## Установка Icinga Web 2 из пакетов <a id="installing-from-package"></a>

[Матрица поддержки](https://icinga.com/subscription/support-details/) официальных репоизиториев:
...
Также могут быть доступны пакеты для дистрибутивов, отличных от перечисленных выше.
Пожалуйста, свяжитесь с вашими дистрибьюторами пакетов.

### Настройка репозиториев пакетов <a id="package-repositories"></a>

Вы должны добавить репозиторий Icinga в конфигурации менеджера пакетов для установки Icinga Web 2.
Если вы уже настроили свою ОС на использование репозитория Icinga для установки Icinga2 - вы можете пропустить этот шаг.
...
Пакеты для RHEL / CentOS зависят от других пакетов, которые распространяются
как часть [репозитория EPEL](https://fedoraproject.org/wiki/EPEL).

CentOS 8 дополнительно требует репозиторий PowerTools для EPEL:
